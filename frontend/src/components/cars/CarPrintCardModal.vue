      ...
      <div class="page">
        <div class="title">
          <h1 class="title__head">
            Пропуск для автомобиля № {{ printCardValue.id ? printCardValue.id : '' }}
          </h1>
          <img
            class="title__img"
        ...
        <div class="page-container">
          <div class="left-part">
            <table class="table-box">
              <tr>
                ...
                <td class="table-box__item">
                  {{ printCardValue.visitor ? printCardValue.visitor.car.regNumber : '' }}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="table-box__item">
                  {{ printCardValue.visitor ? getShortName(printCardValue.visitor) : '' }}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="table-box__item">
                  {{ printCardValue.visitor ? getShortName(printCardValue.employee) : '' }}
                </td>
              </tr>
            </table>
            ...
            <table class="table-box">
              ...
              <tr>
                <th class="table-box__item table-box__item_w50">
                  Дата
                </th>
                <th class="table-box__item">
                  Подпись водителя
                </th>
              </tr>
              <tr>
          ...
          <div class="right-part">
            <table class="table-box">
              ...
              <tr>
                ...
                <td class="table-box__item">
                  {{ printCardValue.visitor ? getShortName(printCardValue.security) : '' }}
                </td>
              </tr>
            </table>
            ...
            <table class="table-box">
              <caption class="table-box__caption">
                Отметки сотрудника ООО "КЛААС"
              </caption>
              <tr>
                <td class="table-box__item table-box__item_w50">
                  Место выгрузки:
              ...
              <tr>
                <td class="table-box__item table-box__item_w50">
                  Груз, количество мест:
                </td>
                <td class="table-box__item" />
              </tr>
              <tr>
                <td class="table-box__item table-box__item_w50">
                  Разгрузку осуществил:
                </td>
                <td class="table-box__item" />
              </tr>
            </table>
        ...
        <div class="page-container">
          <div class="left-part">
            ...
            <ul>
              ...
              <li class="second-page__list-item">
                На территории ООО «КЛААС» водителю разрешено находиться строго в специальной защитной обуви с закрытым носком и пяткой;
              </li>
              <li class="second-page__list-item">
          ...
          <div class="right-part">
            <img
              class="location-map"
              src="@/assets/printCard/carMap.jpg"
            >
          </div>
        </div>
      </div>
